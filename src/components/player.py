...
movement_speed = 2
inventory = Inventory(20) # 20 slots
message_time_seconds = 10
...
up_frames =             [(0, 3), (1, 3), (2, 3), (3, 3)]
right_frames =          [(0, 2), (1, 2), (2, 2), (3, 2)]
left_frames =           [(0, 1), (1, 1), (2, 1), (3, 1)]
down_idle_frames =      [(0, 4), (1, 4), (2, 4), (3, 4)]
up_idle_frames =        [(0, 7), (1, 7), (2, 7), (3, 7)]
right_idle_frames =     [(0, 6), (1, 6), (2, 6), (3, 6)]
left_idle_frames =      [(0, 5), (1, 5), (2, 5), (3, 5)]
...
class Player:
    def __init__(self, health):
        ...
        self.loc_label = Entity(Label("Montserrat-Bold.ttf",
                                        "X: 0 - Y: 0")).get(Label)
        self.message_label = Entity(Label("Montserrat-Bold.ttf",
                                        area.name)).get(Label)
    ...
    def interact(self, mouse_pos):
        ...
        for usable in engine.usables:
            if usable.entity.has(Sprite):
                ...
                # Check if the mouse is clicking the sprite
    ...
    def stop_animation(self):
        ...
        if self.direction == left:
            a.set_frame_coords(left_idle_frames)
        elif self.direction == right:
            a.set_frame_coords(right_idle_frames)
        elif self.direction == down:
            a.set_frame_coords(down_idle_frames)
        elif self.direction == up:
            a.set_frame_coords(up_idle_frames)
