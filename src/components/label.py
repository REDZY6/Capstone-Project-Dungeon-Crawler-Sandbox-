...
anti_alias = True # Ensure font is smooth instead of pixlated
font_folder_path = "content/fonts"

class Label:
    def __init__(self, font, text, size=48, color=(255,255,255)):
    ...
    def set_text(self, text):
        ...
        self.shadow_surface = self.font.render(self.text, anti_alias, (0,0,0)) # Rerender text with darker color

    def draw(self, screen):
        # Shift 1 pixel so that we can see the shadow
